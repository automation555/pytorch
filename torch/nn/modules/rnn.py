...
class RNNBase(Module):
    ...
    def __init__(self, mode: str, input_size: int, hidden_size: int,
                 ...
                 device='cpu', dtype=torch.get_default_dtype()) -> None:
...
class RNNCell(RNNCellBase):
    ...
    def __init__(self, input_size: int, hidden_size: int, bias: bool = True, nonlinearity: str = "tanh",
                 **kwargs) -> None:
        super(RNNCell, self).__init__(input_size, hidden_size, bias, num_chunks=1, **kwargs)
...
class LSTMCell(RNNCellBase):
    ...
    def __init__(self, input_size: int, hidden_size: int, bias: bool = True, **kwargs) -> None:
        super(LSTMCell, self).__init__(input_size, hidden_size, bias, num_chunks=4, **kwargs)
...
class GRUCell(RNNCellBase):
    ...
    def __init__(self, input_size: int, hidden_size: int, bias: bool = True, **kwargs) -> None:
        super(GRUCell, self).__init__(input_size, hidden_size, bias, num_chunks=3, **kwargs)
