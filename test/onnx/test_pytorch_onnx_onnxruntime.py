...
class TestONNXRuntime(unittest.TestCase):
    ...
    def test_data(self):
        ...
        x = torch.randn(3, 4)
        self.run_test(Data(), x, dynamic_axes={"x": [0, 1]})
    ...
    def test_cste_script(self):
        ...
        x = torch.randn(3, 4)
        self.run_test(MyModel(), x, dynamic_axes={"x": [0, 1]})
    ...
    def test_tensor(self):
        ...
        x = torch.randn(3, 4)
        self.run_test(ScalarInputModel(), x, dynamic_axes={"x": [0, 1]})
        ...
        x = torch.randn(3, 4)
        self.run_test(TensorInputModel(), x, dynamic_axes={"x": [0, 1]})
        ...
        x = torch.randn(3, 4)
        self.run_test(InputWithDtypeModel(), x, dynamic_axes={"x": [0, 1]})
    ...
    def test_floating_point(self):
        ...
        x = torch.randn(2, 3, 4)
        self.run_test(FloatingPoint(), x, dynamic_axes={"x": [0, 1, 2]})
    ...
    def test_floordiv(self):
        ...
        x = torch.randn(2, 3, 4)
        self.run_test(FloordivModule(), x, dynamic_axes={"x": [0, 1, 2]})
    ...
    def test_slice_dynamic_shape_script(self):
        ...
        self.run_test(DynamicSliceModel(), x, dynamic_axes={"x": [0, 1, 2, 3]})
    ...
    def test_dynamic_arange_start_out(self):
        ...
        x = torch.randn(2, 3, 4)
        y = torch.tensor(8)
        self.run_test(ArangeStartOutModel(), (x, y), dynamic_axes={"x": [0, 1, 2], "y": [0]})
    ...
    def test_arange(self):
        ...
        self.run_test(ArangeModel(), (x, y), dynamic_axes={"x": [0, 1, 2], "y": [0]})
    ...
    def test_size(self):
        ...
        x = torch.randn(5, 3, 2)
        self.run_test(SizeModel(), x, dynamic_axes={"x": [0, 1, 2]})
    ...
    def test_interpolate_no_shape(self):
        ...
        self.run_test(MyModel(), (x, y), dynamic_axes={"x": [0, 1, 2, 3], "y": [0, 1]})
    ...
    def test_listunpack(self):
        ...
        x = torch.randn(2, 3)
        self.run_test(ListUnpack(), x, dynamic_axes={"x": [0, 1]})
        ...
        self.run_test(ListUnpackSlice(), x, dynamic_axes={"x": [0, 1, 2, 3]})
    ...
    def test_arange_end_notype(self):
        ...
        x = torch.randn(3, 4, requires_grad=True)
        outputs = ArangeScript()(x)
        self.run_test(ArangeScript(), x, dynamic_axes={"x": [0, 1]})
        ...
        self.run_test(ArangeModel(), x, dynamic_axes={"x": [0, 1]})
    ...
    def test__dim_arange(self):
        ...
        x = torch.ones(5, 6)
        self.run_test(DimArange(), x, dynamic_axes={"x": [0, 1]})
    ...
    def test_view_dynamic(self):
        ...
        self.run_test(ViewModel(), (x, shape), dynamic_axes={"x": [0, 1, 2], "shape": [0, 1]})
    ...
    def test_split_size_with_slice(self):
        ...
        y = torch.randn(2, 4)
        t = torch.randn(2, 7)
        self.run_test(SplitModule(), (x, y, t), dynamic_axes={"x": [0, 1], "y": [0, 1], "t": [0, 1]})
    ...
    def test_tensor_factories(self):
        ...
        x = torch.randn(2, 3, 4)
        self.run_test(TensorFactory(), x, dynamic_axes={"x": [0, 1, 2]})
    ...
    def test_inplace_zero(self):
        ...
        x = torch.randn(2, 3, 4)
        self.run_test(Zero_(), x, dynamic_axes={"x": [0, 1, 2]})
    ...
    def test_list_pass(self):
        ...
        self.run_test(Slice(), (x, y), dynamic_axes={"x": [0, 1, 2, 3], "y": [0, 1, 2, 3]})
        ...
        x = torch.randn(2, 3, 4)
        y = torch.randn(1, 2, 3)
        self.run_test(Size(), (x, y), dynamic_axes={"x": [0, 1, 2], "y": [0, 1, 2]})
        ...
        x = torch.randn(2, 3, 4)
        y = torch.randn(1, 2, 3)
        self.run_test(Array(), (x, y), dynamic_axes={"x": [0, 1, 2], "y": [0, 1, 2]})
        ...
        x = torch.randn(2, 3, 4)
        y = torch.randn(1, 2, 3)
        self.run_test(List(), (x, y), dynamic_axes={"x": [0, 1, 2], "y": [0, 1, 2]})
    ...
    def test_new_empty(self):
        ...
        x = torch.randn(2, 3, 4)
        self.run_test(Emtpy(), x, dynamic_axes={"x": [0, 1, 2]})
    ...
    def test_new_full(self):
        ...
        x = torch.randn(2, 3, 4)
        self.run_test(Full(), x, dynamic_axes={"x": [0, 1, 2]})
    ...
    def test_inplace_list(self):
        ...
        x = torch.randn(2, 3)
        y = torch.randn(2, 3)
        self.run_test(Arithmetic(), (x, y), dynamic_axes={"x": [0, 1], "y": [0, 1]})
    ...
    def test_inplace_fill(self):
        ...
        x = torch.randn(2, 3, 4)
        self.run_test(Fill_(), x, dynamic_axes={"x": [0, 1, 2]})
    ...
    def test_set_attr_modules(self):
        ...
        x = torch.randn(3, 256)
        self.run_test(Module(), (x, ), dynamic_axes={"x": [0, 1]})
    ...
    def test_index_put_if_3(self):
        ...
        self.run_test(model, (random_data, empty_tensor),
                      dynamic_axes={"random_data": [0, 1, 2, 3], "empty_tensor": [0, 1, 2, 3, 4]})
        self.run_test(model, (random_data, empty_tensor), remained_onnx_input_idx={'scripting': [], 'tracing': [1]})
    ...
    def test_index_put_inplace_ops(self):
        ...
        model = Example(10)
        random_data = torch.rand((1, 5, 30, 30))
        self.run_test(model, (random_data), dynamic_axes={"random_data": [0, 1, 2, 3]})
    ...
    def test_symbolic_shape_inference(self):
        ...
        self.run_test(model, (x, y), dynamic_axes={"x": [0, 1, 2, 3], "y": [0, 1, 2, 3]})
    ...
    def test_symbolic_shape_inference_arange(self):
        ...
        self.run_test(model, x, dynamic_axes={"x": [0, 1, 2, 3]})
    ...
    def test_symbolic_shape_inference_arange_2(self):
        ...
        x = torch.randn(2, 3, 4)
        self.run_test(ArangeModel(), (x,), dynamic_axes={"x": [0, 1, 2]})
        self.run_test(ArangeModel(), (x,), remained_onnx_input_idx=[])
        ...
        x = torch.randn(2, 3, 4)
        self.run_test(ArangeModel2(), (x,), dynamic_axes={"x": [0, 1, 2]})
    ...
    def test_symbolic_shape_inference_nonzero(self):
        ...
        x = torch.randn(2)
        self.run_test(OneLikeModel(), x, dynamic_axes={"x": [0]})
        self.run_test(OneLikeModel(), x, remained_onnx_input_idx=[])
        x = torch.randn(2, 3, 4)
        self.run_test(OneLikeModel(), x, dynamic_axes={"x": [0, 1, 2]})
        self.run_test(OneLikeModel(), x, remained_onnx_input_idx=[])
        ...
        x = torch.randn(2)
        self.run_test(ZeroLikeModel(), x, dynamic_axes={"x": [0]})
        self.run_test(ZeroLikeModel(), x, remained_onnx_input_idx=[])
        x = torch.randn(2, 3, 4)
        self.run_test(ZeroLikeModel(), x, dynamic_axes={"x": [0, 1, 2]})
        self.run_test(ZeroLikeModel(), x, remained_onnx_input_idx=[])
    ...
    def test_symbolic_shape_inference_expand_2(self):
        ...
        x = torch.randn(3, 16)
        self.run_test(M(), (x,), dynamic_axes={"x": [0, 1]})
    ...
    def test_symbolic_shape_inference_slice(self):
        ...
        self.run_test(M(), (x, position_bias), dynamic_axes={"x": [0, 1], "position_bias": [0, 1, 2, 3]})
